                ...
                >
                  <div className="relative">
                    ...
                    <div className="w-64 h-64 md:w-80 md:h-80 rounded-full border-2 border-gray-200 dark:border-gray-800 overflow-hidden relative z-10">
                      <img
                        src="/IMG_2926 2.JPG?height=400&width=400"
          ...
          >
            <div className="container mx-auto px-4">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {projects.map((project, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <Card className="overflow-hidden h-full bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border-gray-200/50 dark:border-gray-700/50 hover:shadow-lg transition-shadow">
                      <div className="relative">
                        <img
                        ...
                        <div className="flex flex-wrap gap-2">
                          {project.technologies.map((tech) => (
                            <Badge
                              key={tech}
                              variant="outline"
                              className="bg-gray-100/80 dark:bg-gray-700/80 backdrop-blur-sm text-gray-800 dark:text-gray-200 border-0"
                            >
                              {tech}
                            </Badge>
                          ))}
              ...
              <div className="text-center mt-12">
                <Button variant="outline" className="border-gray-300 dark:border-gray-700 backdrop-blur-sm">
                  Ver más proyectos
                </Button>
              </div>
            </div>
                  ...
                  >
                    <div className="hidden sm:block pt-1">
                      <div className="w-12 h-12 rounded-full bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 flex items-center justify-center shadow-sm">
                        <div className="w-3 h-3 rounded-full bg-gradient-to-r from-emerald-500 to-purple-500"></div>
                      </div>
                    ...
                    <Card className="flex-1 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-gray-200/50 dark:border-gray-700/50">
                      <CardContent className="p-6">
                        <Badge className="mb-2 bg-purple-500/10 text-purple-500 dark:bg-purple-400/10 dark:text-purple-400">
                          {item.period}
                        </Badge>
